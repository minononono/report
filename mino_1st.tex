...
また，磁場測定による統計誤差を含んだ$g$ 因子の統計誤差については，各測定点の統計誤差を加重平均の誤差伝播することにによって得られた$\delta B$ とプラスチックシンチレータで求めた誤差伝播の式\eqref{eq:PSgosa}から得た．その結果，$g$ 因子の誤差$\sigma_{B}$ は表~\ref{tab:g_error} の値が得られた．
