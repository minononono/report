...
\centering
\includegraphics[height = 0.9\columnwidth , angle = -90]{lt_layercoin.pdf}
\caption{層でcoincidenceを取って得られたヒストグラム(磁場なし標的)}
\label{lt_layercoin}
\end{subfigure}
\begin{subfigure}{\columnwidth}
\centering
\includegraphics[height = 0.9\columnwidth , angle = -90]{lt_layercoin_fit.pdf}
...
\begin{subfigure}{\columnwidth}
\centering
\includegraphics[height = 0.9\columnwidth , angle = -90]{g_layer_f_coin.pdf}
\caption{層でcoincidenceを取って得られたヒストグラム(磁場あり標的)}
\label{g_layercoin}
\end{subfigure}
\begin{subfigure}{\columnwidth}
\centering
\includegraphics[height = 0.9\columnwidth , angle = -90]{g_laye_f_coin_fit.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height = 0.7\columnwidth , angle = -90]{michel_PS.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height = 0.7\columnwidth , angle = -90]{michel_PS_gosa.pdf}
